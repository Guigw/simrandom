...
use Yrial\Simrandom\Domain\Handler\ChallengeTry\FindTryHandler as DomainFindChallengeDrawHandler;
use Yrial\Simrandom\Domain\Handler\ChallengeTry\SaveTryHandler;
...
use Yrial\Simrandom\Domain\Query\ChallengeTry\FindChallengeTryQuery as DomainFindChallengeDrawQuery;
...
enum HandlerCommand: string
{
    ...
    public function getHandlerClass(): string
    {
        return match ($this) {
            ...
            HandlerCommand::DomainChallengeDrawCommand => SaveTryHandler::class,
